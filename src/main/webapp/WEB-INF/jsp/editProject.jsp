...
<layout:page-container title="KanbanCollab" activePage="editProject">
    ...
    <c:if test="${currentUser.userId == project.owner.userId || currentUser.username == 'admin' || project.projectId == null}">
        ...
        <form:form modelAttribute="project" class="needs-validation form-horizontal" method="post"
            ...
            <label for="inputProjectName" class="col control-label"><spring:message code="editProject.projectname"/></label>
            <div class="col-md-10">
            ...
            <div class="form-group">
            <label for="inputDescription" class="col-md-2 control-label"><spring:message code="editProject.description"/></label>
            <div class="col-md-10">
            ...
            <! ---------------- Members ---------------- -->
                <div class="form-group">
                    <label for="inputMembers" class="col-md-2 control-label"><spring:message code="editProject.members"/></label>
                    <div class="col-md-10">
