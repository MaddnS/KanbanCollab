            ...
            <div id="accordion">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-1">
                                                ...
                                                <svg class="bi bi-three-dots-vertical" height="1.2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="col-lg-3">
                                            <form:form method="post" action="/deleteProject?projectId=${project.projectId}">
                                                <button type="submit" class="btn btn-xs btn-danger">
                                                    <svg class="bi bi-trash" width="0.8em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div class="row">
                            ...
                            <c:forEach items="${sharedProjects}" var="project">
                                ...
                                Mit SQL Inner join funkts net. oof ---->
                ...
                <div class="card">
                    <div class="card-header" id="adminHeading">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#adminCollapse" aria-expanded="false" aria-controls="adminCollapse">
                                    ...
                                    <div class="card-body">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                </div>                                                <p class="card-text">${project.description}</p>
